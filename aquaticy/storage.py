...
jedem Artikel eine eindeutige Nummer gibt (`A1`, `B42`). Damit kann Aquaticy
...
**Rechte.** Was Aquaticy hier darf, steht in den Einstellungen und nur dort:
...
Rechte hier sind also eine Fessel fuer Aquaticy, kein Schloss am Server. Wer den
...
class Storage:
    ...
    def _request(self, method: str, path: str, **kwargs: Any) -> Any:
        ...
        if method != "GET" and not self.may_write:
            raise NotAllowed(
                "Aquaticy darf in der Lagerverwaltung nur lesen. Aendern laesst sich das "
